...
in
{
  flake.nixosModules.desktop =
    ...
    let
      someUserHasDesktop = (
        lib.any (value: value.modules.desktop) (builtins.attrValues config.home-manager.users)
      );
    in
    {
  ...
  flake.homeModules.desktop =
    ...
    {
      options.modules.desktop = lib.mkEnableOption "desktop environment";

      config = lib.mkIf config.modules.desktop {
        # Yakuake
        home.packages =
